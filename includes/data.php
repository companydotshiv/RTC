<?php
/**
 * RTC Foods - Product, Category, and Blog Data
 * Auto-generated from source data modules
 */
...
$GLOBALS['PRODUCTS'] = [
  [
    ...
    'bullets' => [
      [
        ...
        'text' => "Carefully selected California almonds known for their excellent quality and taste."
      ],
      [
        'title' => "Origin",
        'text' => "Sourced from California, USA, one of the world's leading almond-growing regions."
      ],
      [
        'title' => "Rich & Crunchy",
        'text' => "Naturally crunchy with a mildly sweet, delicious flavour."
      ],
      [
        'title' => "Naturally Nutritious",
        'text' => "A natural source of protein, fibre and healthy fats."
      ],
      [
        'title' => "Versatile Snack",
        'text' => "Perfect for snacking, baking, desserts, smoothies and everyday recipes."
      ],
      [
        'title' => "Fresh & Wholesome",
        'text' => "Packed to help retain freshness, crunch and natural flavour."
      ],
      [
        'title' => "Everyday Goodness",
        'text' => "A convenient addition to a balanced and wholesome lifestyle."
      ]
    ],
    'additionalInfoTable' => [
      [
      ...
      [
        'label' => "Product Name",
        'value' => "RTC California Almonds"
      ],
      [
        'label' => "Additive Information",
        'value' => "Refer to the product packaging."
      ],
      [
        'label' => "Product Dimensions",
        'value' => "20 × 15 × 3.5 cm (L × W × H)"
      ],
      [
      ...
      [
        'label' => "Consumer Care",
        'value' => "RTC Foods — info@rtcfoods.in"
      ]
    ],
    'paragraphs' => [
  ...
  [
    ...
    'bullets' => [
      [
        'title' => "",
        'text' => "RTC Foods Chia Seeds are premium-quality seeds known for their mild taste, natural crunch, and exceptional nutritional value."
      ],
      [
        'title' => "",
        'text' => "Hygienically processed and securely packed to preserve freshness, they are a perfect addition to daily wellness routines."
      ],
      [
        'title' => "",
        'text' => "Rich in fiber, plant protein, omega-3 fatty acids, and essential minerals, RTC Foods Chia Seeds support balanced nutrition and healthy living."
      ]
    ],
    'additionalInfoTable' => [
      [
      ...
      [
        'label' => "Common name",
        'value' => "RTC Chia Seeds"
      ],
      [
        'label' => "Additive info",
        'value' => "Refer to the product"
      ],
      [
        'label' => "Product Dimensions",
        'value' => "20L x 15W x 3.5H cm"
      ],
      [
  ...
  [
    ...
    'bullets' => [
      [
        'title' => "Premium Quality Cashews",
        'text' => "Carefully selected whole cashew nuts with a rich, creamy texture and naturally delicious taste."
      ],
      [
        'title' => "Rich in Nutrients",
        'text' => "A good source of healthy fats, protein, dietary fiber, vitamins, and essential minerals like magnesium and zinc."
      ],
      [
        'title' => "Healthy Snacking Option",
        'text' => "Perfect for guilt-free snacking, providing long-lasting energy throughout the day."
      ],
      [
        'title' => "Versatile Use",
        'text' => "Ideal for desserts, curries, gravies, baking, smoothies, and dry fruit mixes."
      ],
      [
        'title' => "Fresh & Hygienically Packed",
        'text' => "Sealed in food-grade packaging to preserve freshness, crunch, and natural flavor."
      ],
      [
        'title' => "Naturally Delicious",
        'text' => "No artificial colors or preservatives; suitable for everyday consumption."
      ]
    ],
    'additionalInfoTable' => [
      [
  ...
  [
    ...
    'gallery' => [
      "/dried_apricot_front.png",
      "/dried_apricot_back.png"
    ],
    ...
    'bullets' => [
      [
        'title' => "Premium Quality Apricots",
        'text' => "Handpicked, naturally sun-dried for rich taste"
      ],
      [
        'title' => "Naturally Sweet & Delicious",
        'text' => "No added artificial flavors or preservatives"
      ],
      [
        'title' => "Rich in Nutrients",
        'text' => "High in fiber, vitamins (A & C), and antioxidants"
      ],
      [
        'title' => "Healthy Snacking Option",
        'text' => "Ideal for boosting energy anytime, anywhere"
      ],
      [
        'title' => "Supports Digestion",
        'text' => "Helps maintain gut health due to high fiber content"
      ],
      [
        'title' => "Multipurpose Use",
        'text' => "Perfect for snacks, desserts, smoothies, and baking"
      ],
      [
        'title' => "Hygienically Packed",
        'text' => "Ensures freshness, purity, and long shelf life"
      ],
      [
        'title' => "Perfect for All Ages",
        'text' => "A nutritious choice for kids and adults alike"
      ]
    ],
    'additionalInfoTable' => [
      [
  ...
  [
    ...
    'gallery' => [
      "/indian_raisins_front.png",
      "/indian_raisins_back.png"
    ],
    ...
    'bullets' => [
      [
        'title' => "Premium Indian Origin",
        'text' => "Sourced from quality farms across India for natural sweetness and freshness."
      ],
      [
        'title' => "Naturally Sweet & Nutritious",
        'text' => "Rich in iron, fiber, and essential nutrients for daily wellness."
      ],
      [
        'title' => "Energy Boosting Snack",
        'text' => "Provides instant energy, making it perfect for daily consumption."
      ],
      [
        'title' => "Supports Digestion",
        'text' => "Contains natural fiber that helps promote healthy digestion."
      ],
      [
        'title' => "Soft & Juicy Texture",
        'text' => "Carefully selected raisins with a plump, soft, and delicious taste."
      ],
      [
        'title' => "Versatile Use",
        'text' => "Ideal for snacking, sweets, baking, cereals, and traditional recipes."
      ],
      [
        'title' => "100% Natural",
        'text' => "No added sugar, preservatives, or artificial flavors."
      ]
    ],
    'additionalInfoTable' => [
      [
  ...
  [
    ...
    'bullets' => [
      [
        'title' => "Premium Quality",
        'text' => "Diamond Grade Afghan Anjeer (Dried Figs)"
      ],
      [
        'title' => "Naturally Sweet",
        'text' => "Rich flavor and soft texture"
      ],
      [
        'title' => "Rich in Fiber",
        'text' => "Good source of dietary fiber and essential minerals"
      ],
      [
        'title' => "Energy & Wellness",
        'text' => "Supports daily energy and overall wellness"
      ],
      [
        'title' => "Hygienically Packed",
        'text' => "Carefully selected and hygienically packed"
      ],
      [
        'title' => "Ideal Snacking",
        'text' => "Ideal for healthy snacking and gifting"
      ]
    ],
    'additionalInfoTable' => [
      [
  ...
  [
    ...
    'gallery' => [
      "/exotic_kiwi_front.png",
      "/exotic_kiwi_back.jpg"
    ],
    ...
    'bullets' => [
      [
        'title' => "",
        'text' => "Premium exotic dried kiwi sourced from Thailand"
      ],
      [
        'title' => "",
        'text' => "Delightfully sweet and tangy tropical flavor"
      ],
      [
        'title' => "",
        'text' => "Soft and chewy texture with vibrant natural color"
      ],
      [
        'title' => "",
        'text' => "Perfect healthy snack for anytime cravings"
      ],
      [
        'title' => "",
        'text' => "Ideal for desserts, cereals, smoothies, and baking"
      ],
      [
        'title' => "",
        'text' => "Rich in dietary fiber and antioxidants"
      ],
      [
        'title' => "",
        'text' => "Great addition to trail mixes and fruit platters"
      ],
      [
        'title' => "",
        'text' => "Carefully selected premium-quality kiwi slices"
      ],
      [
        'title' => "",
        'text' => "Hygienically processed and packed for freshness"
      ],
      [
        'title' => "",
        'text' => "Convenient snack for home, office, or travel"
      ],
      [
        'title' => "",
        'text' => "Adds a tropical twist to recipes and beverages"
      ],
      [
        'title' => "",
        'text' => "Freshness-sealed packaging for long-lasting taste and quality"
      ]
    ],
    'additionalInfoTable' => [
      [
        'label' => "Care Instructions",
        'value' => "Lower temperature washes and delicate spin cycles are gentler on garment, helping to maintain the color, shape and structure of the fabric. At the same time it reduces energy consumption that is used in care processes."
      ],
      [
        'label' => "Model Wears",
        'value' => "UK 10/ EU 38/ US 6"
      ],
      [
        'label' => "Occasion",
        'value' => "Lifestyle, Sport"
      ],
      [
        'label' => "Country",
        'value' => "Italy"
      ...
      [
        'label' => "Outer",
        'value' => "Leather 100%, Polyamide 100%"
      ],
      [
        'label' => "Lining",
        'value' => "Polyester 100%"
  ...
  [
    ...
    'gallery' => [
      "/walnut_platinum_front.jpg",
      "/walnut_platinum_back.png"
    ],
    ...
    'bullets' => [
      [
        'title' => "",
        'text' => "Premium Chile Origin : Top – Quality 2- Piece Walnut Kernels Sourced From Chile, Known For Superior Grade and Consistency."
      ],
      [
        'title' => "",
        'text' => "Light Color & Fine Quality : Clean, uniform appearance with excellent taste and texture."
      ],
      [
        'title' => "",
        'text' => "Fresh & Hygienically Packed : Carefully processed to retain freshness, crunch, and nutritional value."
      ],
      [
        'title' => "",
        'text' => "Ideal for Premium Use : Perfect for snacking, gifting, baking and high end culinary applications."
      ],
      [
        'title' => "",
        'text' => "RTC Foods Quality Assurance : Trusted quality with strict selection and grading standards."
      ]
    ],
    'additionalInfoTable' => [
      [
      ...
      [
        'label' => "Common name",
        'value' => "RTC Walnut kernels (Platinum)"
      ],
      [
        'label' => "Additive info",
        'value' => "Refer to the product"
  ...
  [
    ...
    'gallery' => [
      "/walnut_diamond_front.png",
      "/walnut_diamond_back.jpg"
    ],
    ...
    'bullets' => [
      [
        'title' => "Premium Chile Origin",
        'text' => "High – Quality 2- Piece Walnut Kernals Sourced From India."
      ],
      [
        'title' => "White & Celan Appearance",
        'text' => "Attractive light color with good taste and consistent quality."
      ],
      [
        'title' => "Fresh & Hygenically Packed",
        'text' => "Ensures natural freshness texture, and nutritional intgrity."
      ],
      [
        'title' => "Perfect for daily use",
        'text' => "Suitable for snacking, cooking,baking and regular consumption."
      ],
      [
        'title' => "Rtc foods Quality Assurance",
        'text' => "From a brand committed to purity and premium standards."
      ]
    ],
    'additionalInfoTable' => [
      [
      ...
      [
        'label' => "Common name",
        'value' => "RTC Walnut kernals (Diamond)"
      ],
      [
        'label' => "Additive info",
        'value' => "Refer to the product"
  ...
  [
    ...
    'gallery' => [
      "/walnut_gold_front.png",
      "/walnut_gold_back.png"
    ],
    ...
    'bullets' => [
      [
        'title' => "Reliable Everyday quality",
        'text' => "2- piece walnut kernals with natural golden color for regular use."
      ],
      [
        'title' => "Balance Taste & Value",
        'text' => "Offers good taste and quality at an economical price point."
      ],
      [
        'title' => "Fresh & hygenically Packed",
        'text' => "Packed to maintain freshness amd usability."
      ],
      [
        'title' => "Versatile Usage",
        'text' => "Ideal For cooking baking, snacking and daily nutrition."
      ],
      [
        'title' => "Rtcfoods Quality Assurance",
        'text' => "Consistent quality From a Trusted dry fruit brand."
      ]
    ],
    'additionalInfoTable' => [
      [
  ...
  [
    ...
    'gallery' => [
      "/walnut_silver_front.png",
      "/walnut_silver_back.png"
    ],
    ...
    'bullets' => [
      [
        'title' => "Economical 4 – piece kernals",
        'text' => "Value pack walnut kernals suitable for bulk and daily use."
      ],
      [
        'title' => "White Apperanance",
        'text' => "Clean look with Practical quality for regular consumption."
      ],
      [
        'title' => "Fresh & hygenically Packed",
        'text' => "Freshness and usability for longer duration."
      ],
      [
        'title' => "Best for cooking & Baking",
        'text' => "Ideal for recipes, deserts, and large – scale usage."
      ],
      [
        'title' => "Rtc Foods Quality Assurance",
        'text' => "Affordable option witrhout compromising on essential quality."
      ]
    ],
    'additionalInfoTable' => [
      [
      ...
      [
        'label' => "Common name",
        'value' => "RTC Walnut kernals (Silver)"
      ],
      [
        'label' => "Additive info",
        'value' => "Refer to the product"
  ...
  [
    ...
    'gallery' => [
      "/dry_figs_gold_front.png",
      "/dry_figs_gold_back.png"
    ],
    ...
    'bullets' => [
      [
        'title' => "",
        'text' => "Premium quality Gold dry figs sourced from Afghanistan"
      ],
      [
        'title' => "",
        'text' => "Naturally large size, soft texture & rich sweetness"
      ],
      [
        'title' => "",
        'text' => "High in dietary fiber, calcium & antioxidants"
      ],
      [
        'title' => "",
        'text' => "Supports digestion, bone strength & overall wellness"
      ],
      [
        'title' => "",
        'text' => "Naturally dried with no added preservatives or chemicals"
      ],
      [
        'title' => "",
        'text' => "Carefully sorted, cleaned & hygienically packed"
      ],
      [
        'title' => "",
        'text' => "Ideal for healthy snacking, desserts & daily nutrition"
      ],
      [
        'title' => "",
        'text' => "Perfect for fasting, gifting & festive use"
      ],
      [
        'title' => "",
        'text' => "Best stored in a cool & dry place for freshness"
      ]
    ],
    'additionalInfoTable' => [
      [
  ...
  [
    ...
    'bullets' => [
      [
        'title' => "",
        'text' => "Premium quality Jumbo size dry dates sourced directly from Iran"
      ],
      [
        'title' => "",
        'text' => "Attractive golden color with firm & chewy texture"
      ],
      [
        'title' => "",
        'text' => "Naturally mild sweet taste with nutty flavor"
      ],
      [
        'title' => "",
        'text' => "Rich in dietary fiber, iron & potassium for daily nutrition"
      ],
      [
        'title' => "",
        'text' => "Helps support digestion, energy & overall health"
      ],
      [
        'title' => "",
        'text' => "Carefully cleaned and hygienically packed"
      ],
      [
        'title' => "",
        'text' => "Ideal for healthy snacking, gifting & daily consumption"
      ],
      [
        'title' => "",
        'text' => "Long shelf life when stored in a cool & dry place"
      ]
    ],
    'additionalInfoTable' => [
      [
  ...
  [
    ...
    'gallery' => [
      "/black_raisins_front.png",
      "/black_raisins_back.png"
    ],
    ...
    'bullets' => [
      [
        'title' => "",
        'text' => "Premium Afghanistan Origin: Sourced from high-quality Afghan farms known for rich, naturally sweet raisins."
      ],
      [
        'title' => "",
        'text' => "Nutrient-Rich Snack: High in iron, fiber, and antioxidants for overall health support."
      ],
      [
        'title' => "",
        'text' => "Supports Digestion: Natural fiber helps promote better gut health."
      ],
      [
        'title' => "",
        'text' => "Energy Boosting: Provides quick and sustained energy throughout the day."
      ],
      [
        'title' => "",
        'text' => "Soft & Juicy Texture: Plump, naturally sweet, and delicious in every bite."
      ],
      [
        'title' => "",
        'text' => "Versatile Usage: Ideal for snacking, desserts, sweets, cereals, and traditional recipes."
      ],
      [
        'title' => "",
        'text' => "100% Natural: No added sugar, preservatives, or artificial additives."
      ]
    ],
    'additionalInfoTable' => [
      [
  ...
  [
    ...
    'gallery' => [
      "/cranberries_gold_front.jpg",
      "/cranberries_gold_back.png"
    ],
    ...
    'bullets' => [
      [
        'title' => "",
        'text' => "Premium quality whole dried cranberries sourced from the USA"
      ],
      [
        'title' => "",
        'text' => "Naturally sweet and tangy flavor with rich fruity taste"
      ],
      [
        'title' => "",
        'text' => "Soft, chewy texture ideal for daily snacking"
      ],
      [
        'title' => "",
        'text' => "Perfect for cereals, oatmeal, salads, desserts, and baking"
      ],
      [
        'title' => "",
        'text' => "Rich source of antioxidants and dietary fiber"
      ],
      [
        'title' => "",
        'text' => "Convenient healthy snack for home, office, or travel"
      ],
      [
        'title' => "",
        'text' => "Hygienically packed to retain freshness and flavor"
      ],
      [
        'title' => "",
        'text' => "Suitable for smoothies, trail mixes, cookies, and cakes"
      ],
      [
        'title' => "",
        'text' => "Carefully selected berries with vibrant color and taste"
      ],
      [
        'title' => "",
        'text' => "No artificial flavor added"
      ],
      [
        'title' => "",
        'text' => "Resealable packaging for long-lasting freshness"
      ],
      [
        'title' => "",
        'text' => "Ideal for health-conscious consumers and gourmet recipes"
      ]
    ],
    'additionalInfoTable' => [
      [
  ...
  [
    ...
    'gallery' => [
      "/dried_blueberries_front.png",
      "/dried_blueberries_back.png"
    ],
    ...
    'bullets' => [
      [
        'title' => "",
        'text' => "Premium exotic dried blueberries sourced from the USA"
      ],
      [
        'title' => "",
        'text' => "Naturally sweet and mildly tangy fruity flavor"
      ],
      [
        'title' => "",
        'text' => "Soft and chewy texture with rich blueberry taste"
      ],
      [
        'title' => "",
        'text' => "Perfect for snacking, baking, cereals, and desserts"
      ],
      [
        'title' => "",
        'text' => "Rich source of antioxidants and dietary fiber"
      ...
      [
        'title' => "",
        'text' => "Ideal for smoothies, yogurt bowls, and trail mixes"
      ],
      [
        'title' => "",
        'text' => "Carefully selected high-quality blueberries"
      ],
      [
        'title' => "",
        'text' => "Hygienically processed and packed for freshness"
      ...
      [
        'title' => "",
        'text' => "Adds delicious flavor to muffins, cookies, and salads"
      ],
      [
        'title' => "",
        'text' => "No artificial flavor added"
    ...
    'additionalInfoTable' => [
      ...
      [
        'label' => "Common name",
        'value' => "RTC Exotic Dried Blueberries"
      ],
      [
        'label' => "Additive info",
        'value' => "Refer to the product"
  ...
  [
    ...
    'bullets' => [
      [
        'title' => "",
        'text' => "Premium quality dried prunes sourced from the USA"
      ],
      [
        'title' => "",
        'text' => "Naturally sweet flavor with soft and juicy texture"
      ],
      [
        'title' => "",
        'text' => "Rich source of dietary fiber and antioxidants"
      ],
      [
        'title' => "",
        'text' => "Ideal healthy snack for everyday consumption"
      ],
      [
        'title' => "",
        'text' => "Perfect for smoothies, desserts, baking, and breakfast bowls"
      ],
      [
        'title' => "",
        'text' => "Helps add natural sweetness to recipes"
      ],
      [
        'title' => "",
        'text' => "Carefully selected fruits for consistent quality and taste"
      ],
      [
        'title' => "",
        'text' => "Hygienically processed and packed for freshness"
      ...
      [
        'title' => "",
        'text' => "Convenient snack option for home, office, or travel"
      ],
      [
        'title' => "",
        'text' => "Suitable for trail mixes, salads, and energy snacks"
      ],
      [
        'title' => "",
        'text' => "No artificial flavor added"
      ...
      [
        'title' => "",
        'text' => "Freshness-sealed packaging for long-lasting quality"
      ]
    ],
    'additionalInfoTable' => [
      [
  ...
  [
    ...
    'bullets' => [
      [
        'title' => "",
        'text' => "Premium Quality Ajino – Sourced and processed in India"
      ],
      [
        'title' => "",
        'text' => "Enhances Taste Instantly – Adds rich umami flavor to dishes"
      ],
      [
        'title' => "",
        'text' => "Perfect for Cooking – Ideal for Chinese, snacks & fast food"
      ],
      [
        'title' => "",
        'text' => "Fine Crystal Texture – Easy to mix and dissolve"
      ],
      [
        'title' => "",
        'text' => "Multipurpose Use – Suitable for soups, noodles, fried rice & more"
      ],
      [
        'title' => "",
        'text' => "Hygienically Packed – Ensures freshness and purity"
      ],
      [
        'title' => "",
        'text' => "Strong Flavor Booster – Elevates taste with small quantity"
      ],
      [
        'title' => "",
        'text' => "Consistent Quality – Trusted for everyday cooking"
      ]
    ],
    'additionalInfoTable' => [
      [
  ...
  [
    ...
    'bullets' => [
      [
        'title' => "",
        'text' => "Sun-dried premium quality Kasuri Methi"
      ],
      [
        'title' => "",
        'text' => "Delivers authentic aroma and rich herbal taste"
      ],
      [
        'title' => "",
        'text' => "Perfect for parathas, paneer dishes, and curries"
      ],
      [
        'title' => "",
        'text' => "Hygienically packed to retain essential oils and aroma"
      ]
    ],
    'additionalInfoTable' => [
      [
...
$GLOBALS['BLOG_POSTS'] = [
  [
    ...
    'nutritionalHighlights' => [
      [
        'label' => "Natural Oil Content",
        'value' => "Up to 50% in Mamra"
      ],
      [
        'label' => "Dietary Fiber",
        'value' => "12.5g per 100g"
      ],
      [
        'label' => "Plant Protein",
        'value' => "21.2g per 100g"
      ],
      [
        'label' => "Vitamin E",
        'value' => "100% RDA in 30g"
      ]
    ],
    'tags' => [
      "Almonds",
  ...
  [
    ...
    'nutritionalHighlights' => [
      [
        'label' => "Omega-3 ALA",
        'value' => "2.5g per 28g serving"
      ],
      [
        'label' => "Antioxidants",
        'value' => "Top among all nuts"
      ],
      [
        'label' => "Heart Health",
        'value' => "Lowers LDL cholesterol"
      ],
      [
        'label' => "Magnesium",
        'value' => "44mg per serving"
      ]
    ],
    'tags' => [
      "Walnuts",
  ...
  [
    ...
    'nutritionalHighlights' => [
      ...
      [
        'label' => "Shelf Life",
        'value' => "Extended to 12 months"
      ],
      [
        'label' => "Container",
        'value' => "Glass or multi-layer foil"
      ],
      [
        'label' => "Moisture Risk",
        'value' => "Prevent with airtight seals"
      ]
    ],
    'tags' => [
      "Storage Tips",
  ...
  [
    ...
    'nutritionalHighlights' => [
      ...
      [
        'label' => "Plant Protein",
        'value' => "9g in Pumpkin seeds"
      ],
      [
        'label' => "Hydration Power",
        'value' => "10x water retention"
      ]
    ],
    'tags' => [
      "Seeds",
  ...
  [
    ...
    'nutritionalHighlights' => [
      [
        'label' => "Crocin Reading",
        'value' => "> 220 Grade-1"
      ],
      [
        'label' => "Safranal",
        'value' => "Natural sleep promoter"
      ],
      [
        'label' => "Harvest Area",
        'value' => "Pampore, Kashmir"
      ],
      [
        'label' => "Serving Size",
        'value' => "3-4 strands daily"
      ]
    ],
    'tags' => [
      "Saffron",
  ...
  [
    ...
    'nutritionalHighlights' => [
      ...
      [
        'label' => "Customization",
        'value' => "Full OEM / Corporate"
      ],
      [
        'label' => "Packaging",
        'value' => "Luxury Wood / Rigid"
      ],
      [
        'label' => "Pan-India",
        'value' => "Courier safe"
...
$GLOBALS['COUPONS'] = [
  ...
  'FESTIVE20' => [
    ...
    'value' => 20,
    'min_order' => 999,
    'description' => 'Special Festive 20% OFF on orders above ₹999'
  ],
  'RTCFREE' => [
    'code' => 'RTCFREE',
    'type' => 'shipping',
...
function get_product_by_slug($slug) {
    $slugLower = strtolower(trim((string)$slug));
    foreach (get_all_products() as $product) {
        if (strtolower($product['slug'] ?? '') === $slugLower || (string)$product['id'] === $slugLower) {
            return $product;
        }
    }
    return null;
...
function get_blog_post_by_slug($slug) {
    $slugLower = strtolower(trim((string)$slug));
    foreach (get_all_blog_posts() as $post) {
        if (strtolower($post['slug'] ?? '') === $slugLower || (string)$post['id'] === $slugLower) {
            return $post;
        }
    }
    return null;
